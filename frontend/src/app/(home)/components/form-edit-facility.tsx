...
interface FormEditFacilityProps {
  type?: "EDIT";
  defaultValues?: {
    id?: string; // Include ID to support editing
    name: string;
    type: string;
...
const FormEditFacility: FC<FormEditFacilityProps> = ({ type, defaultValues }) => {
  const { updateFacilityData, loading, error } = useFormStore();
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (type === "EDIT") {
      ...
      updateFacilityData(formData.id,{ ...formData, files: fileNames });
    }
  };
